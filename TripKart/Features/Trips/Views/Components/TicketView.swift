...
/// Renders a boarding-pass style ticket — used both inline and for PDF export via ImageRenderer.
            ...
            HStack(alignment: .bottom, spacing: 0) {
                ...
                VStack(spacing: 4) {
                    Text(booking.outboundResult.duration)
                        .font(.system(size: 10))
                        .foregroundStyle(Color.gray)
                    Image(systemName: booking.outboundResult.pluginType == "flight"
                          ? "airplane" : "bus.fill")
                        .font(.system(size: 16))
                        .foregroundStyle(Color(red: 0.0, green: 0.47, blue: 0.95))
